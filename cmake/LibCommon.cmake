...
if(WITH_TESTUTILS)
    ...
    include_directories( ${TestUtils_INCLUDE_DIR})
    link_directories( ${TestUtils_LIBRARY_DIR})
    link_libraries( ${TestUtils_LIBRARY})
...
if(WITH_FACETOOLS)
    ...
    include_directories( ${FaceTools_INCLUDE_DIR})
    link_directories( ${FaceTools_LIBRARY_DIR})
    link_libraries( ${FaceTools_LIBRARY})
    set(WITH_CGAL TRUE)
    set(WITH_DLIB TRUE)
...
if(WITH_QTOOLS)
    ...
    include_directories( ${QTools_INCLUDE_DIR})
    link_directories( ${QTools_LIBRARY_DIR})
    link_libraries( ${QTools_LIBRARY})
    set(WITH_QT TRUE)
    set(WITH_RVTK TRUE)
endif()
...
if(WITH_RMODELIO)
    ...
    include_directories( ${rModelIO_INCLUDE_DIR})
    link_directories( ${rModelIO_LIBRARY_DIR})
    link_libraries( ${rModelIO_LIBRARY})
...
if(WITH_RPASCALVOC)
    ...
    link_libraries( ${rPascalVOC_LIBRARY})
...
if(WITH_RLEARNING)
    ...
    link_libraries( ${rLearning_LIBRARY})
    set(WITH_RFEATURES TRUE)
endif()
...
if(WITH_EIGEN) # Eigen3
    if(WIN32)
        set( EIGEN3_INCLUDE_DIR "${LOCALLIBS}/eigen3")
    else()
...
if(WITH_OPENCV) # OpenCV
    if(WIN32)
        set( OpenCV_DIR "${LOCALLIBS}/opencv2.4")
    else()
...
if(WITH_CGAL)   # CGAL
    if(WIN32)
        set( CGAL_DIR "${LOCALLIBS}/CGAL/")
    endif()
    find_package( CGAL COMPONENTS Core)
    set( CGAL_DONT_OVERRIDE_CMAKE_FLAGS TRUE CACHE BOOL "blah")
    include( ${CGAL_USE_FILE})
    link_libraries( ${CGAL_LIBRARIES})
endif()

if(WITH_DLIB)
    set( dlib_DIR "${LOCALLIBS}/dlib/lib/cmake/dlib")
